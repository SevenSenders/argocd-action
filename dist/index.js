...
const yaml = __nccwpck_require__(361);
const {execSync} = __nccwpck_require__(317);
const core = __nccwpck_require__(491);
const {ECRClient, BatchGetImageCommand, PutImageCommand} = __nccwpck_require__(249);
...
const argocd_host = (env === 'prod' || env === 'uat') ? argocd_servers.prod : argocd_servers.dev;
